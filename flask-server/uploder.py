...
def upload_to_blob_storage(source_filenames,display_filenames):
    ...
    for i in range(len(source_filenames)):
        ...
        image_link_list.append('https://securevision.blob.core.windows.net/'+image_container_name+'/'+display_filename)
...
def upload_video(source_filename,display_filename):
    ...
    return 'https://securevision.blob.core.windows.net/'+video_container_name+'/'+display_filename
