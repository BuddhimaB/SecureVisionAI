...
export default function Register() {
    ...
    const [lastName, setlastName] = useState(''); // State for full name
                ...
                <div className="RegisterLeft">
                    ...
                    <div className="inputField">
                        <input 
                            ...
                            onChange={(e) => firstName(e.target.value)} // Update state on change
                        />
                        <input 
                            className='inputField'
                            type="text" 
                            ...
                            value={fullName} // Bind input value to state
                            onChange={(e) => set(e.target.value)} // Update state on change
                        />
                        <input 
                            className='inputField'
                            type="email" 
