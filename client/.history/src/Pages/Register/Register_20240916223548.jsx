...
export default function Register() {
    ...
    const [firstName, setfirstName] = useState(''); // State for full name
    const [lasttName, setlastName] = useState(''); // State for full name
    ...
    const handleRegister = async () => {
        ...
        if (!firstName|| lasttName || !email || !password || !confirmPassword) {
        ...
        try {
            ...
            const response = await register(firstName,lasttName, email, password);
