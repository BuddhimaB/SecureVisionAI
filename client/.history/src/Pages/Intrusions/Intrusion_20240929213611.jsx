          ...
          {recentIntrusion ? (
            <>
              ...
              <div className="intrusion-images">
                <img
                  src={recentIntrusion.images && local_Intrutuons.getIntrusionImages(recentIntrusion.id, recentIntrusion.images[0])}
                  alt="Latest Intrusion"
                  style={{ width: '100%', height: 'auto' }}
                />
              </div>
              <div className="intrusion-video">
                <video src={local_Intrutuons.openIntrusionVideo(recentIntrusion.id)} controls width="100%" />
              </div>
            </>
          ) : (
