...
const Home = () => {
  ...
  const [cameraId, setCameraId] = useState(localStorage.getItem('cameraId') || ''); // Initialize state with local storage or empty string
  ...
  useEffect(() => {
    const updateCameraId = () => {
      ...
      if (updatedCameraId && updatedCameraId !== cameraId) {
        ...
        console.log("This is the camera that integrated:", updatedCameraId);
