...
const Home = () => {
  ...
  return (
    <div>
      ...
      <div>
      <button type="button" className="btn btn-primary" data-toggle="modal" data-target="#addCameraModal">
        Add Camera
      </button>
      <AddCameraModal />
    </div>
      ...
      <div className="dashboard-container">
        ...
        <div className="right-section">
          ...
          <img
          src={`${MODEL_API_HOST}/video_feed/803477bd-ccf1-4a85-8c96-4b2fff6e4707`}
          width={380}
          height={240}
          alt="CCTV video"
          onError={(event) => {
