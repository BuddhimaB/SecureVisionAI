...
const Home = () => {
  ...
  const [cameraDataForLocal,setCameraDataForLocal] =useState(localStorage.getItem('cameraDataForLocal'));
...
const handleRecordCamera = async () =>{
  const newState = cameraDataForLocal.status === "RUNNING" ? "STOP" : "RUNNING";
  const data = {
    id: cameraDataForLocal.id,
    systemId: cameraDataForLocal.
  }
}
