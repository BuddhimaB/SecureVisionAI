...
const Home = () => {
  ...
  const handleDeleteCamera = () => {
    localStorage.removeItem('cameraId'); // Remove cameraId from localStorage
    setCameraId(null); // Set the state to null to hide the camera feed
          ...
          <div className="camera-grid">
            ...
            {cameraId && (
              <section className="camera-section">
                ...
                />
                <button onClick={handleDeleteCamera} className="delete-button">
                  Delete Camera
                </button>
              </section>
            )}
