    ...
    <div className="intrusion-container">
      ...
      <div className="recent-intrusion">
        ...
        <div className="intrusion-video">
          <video data-testid="recent-intrusion-video" src={recentIntrusion.video} controls />
        </div>
      </div>
      ...
      {selectedIntrusion && (
        <div data-testid="intrusion-modal" className="intrusion-modal">
          <div className="modal-content">
            ...
            <div className="intrusion-video">
              <video data-testid="modal-intrusion-video" src={selectedIntrusion.video} controls />
            </div>
          </div>
        </div>
      )}
